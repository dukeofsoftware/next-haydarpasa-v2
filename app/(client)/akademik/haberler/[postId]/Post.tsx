  ...
  return (
    <ContainerComp classNames="pt-[5rem]  flex flex-col gap-2 min-h-screen items-center">
      ...
      <div className="w-[90%]">
        ...
        <p className="firstle w-full text-base text-gray-700  first-letter:float-left first-letter:mr-3 first-letter:font-serif first-letter:text-7xl first-letter:font-bold first-letter:uppercase first-letter:italic first-letter:text-black ">
          {post.content}
        </p>
      </div>
    </ContainerComp>
