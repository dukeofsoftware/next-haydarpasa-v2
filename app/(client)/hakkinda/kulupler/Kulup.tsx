...
function Kulup({ kulup }: KulupProps) {
  return (
    <Link
      ...
      className="  relative m-4  flex h-full min-h-[180px] w-full xs:min-w-[340px] max-w-[550px] grid-cols-9   flex-col  items-center justify-center rounded-lg bg-primary-1 p-2 shadow-lg duration-300 ease-out   hover:scale-[1.03] md:w-[calc(50%-2rem)] lg:grid lg:p-2 "
    >
