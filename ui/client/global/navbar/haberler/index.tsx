...
function Haberler({ posts }: Posts) {
  ...
  return (
    <div className="   hide-scrollbar fixed  left-0 z-40 hidden h-full min-h-screen w-8/12 gap-3 overflow-y-auto bg-black/90   pt-[200px]  backdrop-blur-md  delay-75 xl:block xl:w-10/12 xl:px-[5%] ">
